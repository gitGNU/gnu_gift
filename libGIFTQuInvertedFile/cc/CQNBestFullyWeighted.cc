...
*
*/
CQNBestFullyWeighted::CQNBestFullyWeighted(const 
					   CAcInvertedFile* 
					   inAccessor):
...
*
*/
void CQNBestFullyWeighted::considerQueryFeature(const CWeightingFunction& 
						inFeature){
...
*
*/
CQNBestfullyWeighted* CQueryNormalizer::clone()const{
    return new CQNBestFullyWeighted(*this);
}
